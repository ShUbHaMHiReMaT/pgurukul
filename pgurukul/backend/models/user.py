...
class User(db.Model, UserMixin):
    ...
    sent_mentions = db.relationship("Mention", foreign_keys="Mention.mentioned_by_id", back_populates="mentioned_by")
    received_mentions = db.relationship("Mention", foreign_keys="Mention.mentioned_user_id", back_populates="mentioned_user")
    notifications = db.relationship("Notification", back_populates="user", cascade="all, delete-orphan")
    tasks_assigned = db.relationship("TaskAssignment", back_populates="user", cascade="all, delete-orphan")
    uploaded_files = db.relationship("File", back_populates="uploader", foreign_keys="File.uploader_id")
    ...
    def online(self) -> bool:
        ...
        return delta < 180  # 3 minutes threshold
